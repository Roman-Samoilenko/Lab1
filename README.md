...
n1 меньше n4, но больше n2 и n3}
    C --|нет|--> D{n2 меньше n1, но больше n3 и n4 или
n2 меньше n3, но больше n1 и n4 или
n2 меньше n4, но больше n1 и n3}
    C --|да|--> CC[Вывод: n1]
    D --|нет|--> E{n3 меньше n1, но больше n2 и n4 или
n3 меньше n2, но больше n1 и n4 или
n3 меньше n4, но больше n1 и n2}
    D --|да|--> DD[Вывод: n2]
    E --|нет|--> F[Вывод: n4]
    E --|да|--> FF[Вывод: n3]
```
